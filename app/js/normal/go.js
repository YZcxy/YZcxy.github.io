...
function go () {
  typish('#typer')
    ...
    .type('今天兵長大人教你写代码呀', '<span class="note">')
    .type('0', '<br>')
    .type('00', '<span class="blank">')
    .wait(10)
    ...
    .type('00', '<span class="blank">')
    .wait(10)
    .type('先来一个大大的 Mua~ o(*≧▽≦)ツ', '<span class="note">')
    .wait(10)
    .then(() => {
      memeda()
    })
  ...
  // 第一个options
    ...
    .type(':', '<span class="blue">')
    .type('0', '<span class="blank">')
    .type("'袁川东'", '<span class="green">')
    .wait(15)
    .del(6)
    .type('0', '<span class="blank">')
    .type("'兵長大人'", '<span class="green">')
    .type(',', '<span class="gray">')
    .type('0', '<br>')
    .type('0000', '<span class="blank">')
